...
/* harmony import */ var _util_apiV3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/apiV3 */ "./src/api/blockchains/ton/util/apiV3.ts");
/* harmony import */ var _util_dns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util/dns */ "./src/api/blockchains/ton/util/dns.ts");
...
/* harmony import */ var _common_addresses__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/addresses */ "./src/api/common/addresses.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./src/api/blockchains/ton/constants.ts");
...
async function resolveAddress(network, address) {
  ...
  if (known) {
    ...
    return {
      address,
      ...known,
      name: (_domain = domain) !== null && _domain !== void 0 ? _domain : known.name
    };
  }
  return {
    address,
...
/* harmony import */ var _util_isMnemonicPrivateKey__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../util/isMnemonicPrivateKey */ "./src/util/isMnemonicPrivateKey.ts");
...
async function tryMigratingMnemonicEncryption(accountId, mnemonic, password) {
  try {
    ...
    await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_5__.setAccountValue)(accountId, 'mnemonicsEncrypted', mnemonicEncrypted)]);
  } catch (err) {
    // eslint-disable-next-line no-console
    console.error(err);
  }
...
/* harmony export */ });
/* unused harmony exports WALLET_IS_BOUNCEABLE, ContractType */
...
/* harmony export */ });
/* unused harmony export nominatorPoolConfigToCell */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util */ "./src/api/blockchains/ton/util/index.ts");
/* harmony import */ var _util_metadata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util/metadata */ "./src/api/blockchains/ton/util/metadata.ts");
/* harmony import */ var _util_tonapiio__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util/tonapiio */ "./src/api/blockchains/ton/util/tonapiio.ts");
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./constants */ "./src/api/blockchains/ton/constants.ts");
/* harmony import */ var _transactions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./transactions */ "./src/api/blockchains/ton/transactions.ts");
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./wallet */ "./src/api/blockchains/ton/wallet.ts");
...
async function getAccountNfts(accountId, offset, limit) {
  ...
  const rawNfts = await (0,_util_tonapiio__WEBPACK_IMPORTED_MODULE_6__.fetchAccountNfts)(network, address, {
    offset,
    limit
  });
...
async function submitNftTransfers(options) {
  ...
  const messages = nftAddresses.map((nftAddress, index) => {
    const nft = nfts === null || nfts === void 0 ? void 0 : nfts[index];
    const isNotcoinBurn = (nft === null || nft === void 0 ? void 0 : nft.collectionAddress) === _config__WEBPACK_IMPORTED_MODULE_1__.NOTCOIN_VOUCHERS_ADDRESS && (toAddress === _config__WEBPACK_IMPORTED_MODULE_1__.BURN_ADDRESS || _config__WEBPACK_IMPORTED_MODULE_1__.NOTCOIN_EXCHANGERS.includes(toAddress));
    const payload = isNotcoinBurn ? buildNotcoinVoucherExchange(fromAddress, nftAddress, nft.index) : buildNftTransferPayload(fromAddress, toAddress, comment);
    return {
      payload,
      amount: _constants__WEBPACK_IMPORTED_MODULE_9__.NFT_TRANSFER_TONCOIN_AMOUNT,
      toAddress: nftAddress
...
function buildNotcoinVoucherExchange(fromAddress, nftAddress, nftIndex) {
  ...
  const payload = new _ton_core__WEBPACK_IMPORTED_MODULE_0__.Builder().storeUint(0x5fec6642, 32).storeUint(nftIndex, 64).endCell();
...
function buildNftTransferPayload(fromAddress, toAddress, payload) {
  let forwardAmount = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _constants__WEBPACK_IMPORTED_MODULE_9__.NFT_TRANSFER_TONCOIN_FORWARD_AMOUNT;
  let builder = new _ton_core__WEBPACK_IMPORTED_MODULE_0__.Builder().storeUint(_constants__WEBPACK_IMPORTED_MODULE_9__.NftOpCode.TransferOwnership, 32).storeUint((0,_util__WEBPACK_IMPORTED_MODULE_4__.generateQueryId)(), 64).storeAddress(_ton_core__WEBPACK_IMPORTED_MODULE_0__.Address.parse(toAddress)).storeAddress(_ton_core__WEBPACK_IMPORTED_MODULE_0__.Address.parse(fromAddress)).storeBit(false) // null custom_payload
...
/* harmony export */ });
/* unused harmony export buildLiquidStakingWithdraw */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony export */ });
/* unused harmony export getTokenWallet */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../config */ "./src/config.ts");
/* harmony import */ var _util_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../util/account */ "./src/util/account.ts");
...
/* harmony export */ });
/* unused harmony exports checkHasTransaction, resolveTransactionError, fetchNewestTxId */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../types */ "./src/api/types/index.ts");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../config */ "./src/config.ts");
...
/* harmony import */ var _util_sendExternal__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./util/sendExternal */ "./src/api/blockchains/ton/util/sendExternal.ts");
/* harmony import */ var _util_tonapiio__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./util/tonapiio */ "./src/api/blockchains/ton/util/tonapiio.ts");
/* harmony import */ var _util_tonCore__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./util/tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* harmony import */ var _common_accounts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../common/accounts */ "./src/api/common/accounts.ts");
/* harmony import */ var _common_backend__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../common/backend */ "./src/api/common/backend.ts");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../common/helpers */ "./src/api/common/helpers.ts");
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../common/utils */ "./src/api/common/utils.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../errors */ "./src/api/errors.ts");
/* harmony import */ var _address__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./address */ "./src/api/blockchains/ton/address.ts");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./auth */ "./src/api/blockchains/ton/auth.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./constants */ "./src/api/blockchains/ton/constants.ts");
/* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./tokens */ "./src/api/blockchains/ton/tokens.ts");
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./wallet */ "./src/api/blockchains/ton/wallet.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
async function checkTransactionDraft(options) {
  ...
  try {
    ...
    const {
      isInitialized
    } = await (0,_wallet__WEBPACK_IMPORTED_MODULE_27__.getContractInfo)(network, toAddress);
...
function estimateDiesel(address, tokenAddress) {
  return (0,_common_backend__WEBPACK_IMPORTED_MODULE_19__.callBackendGet)('/diesel/estimate', {
    address,
    tokenAddress
  });
}
async function checkToAddress(network, toAddress) {
  ...
  const {
    ...
    isTestOnly,
    isBounceable
  } = (0,_util_tonCore__WEBPACK_IMPORTED_MODULE_17__.parseAddress)(toAddress);
...
async function submitTransfer(options) {
  ...
  try {
    const [wallet, account, keyPair] = await Promise.all([(0,_wallet__WEBPACK_IMPORTED_MODULE_27__.pickAccountWallet)(accountId), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_18__.fetchStoredAccount)(accountId), (0,_auth__WEBPACK_IMPORTED_MODULE_24__.fetchKeyPair)(accountId, password)]);
    const {
      address: fromAddress
    } = account;
    const {
    ...
    const {
      balance
    } = await (0,_wallet__WEBPACK_IMPORTED_MODULE_27__.getWalletInfo)(network, wallet);
    const isFullTonBalance = !tokenAddress && balance === amount;
    const {
      seqno,
      transaction
    ...
    const {
      msgHash,
      boc
    } = await (0,_util_sendExternal__WEBPACK_IMPORTED_MODULE_15__.sendExternal)(client, wallet, transaction);
...
async function submitTransferWithDiesel(options) {
  ...
  const [account, keyPair] = await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_18__.fetchStoredAccount)(accountId), (0,_auth__WEBPACK_IMPORTED_MODULE_24__.fetchKeyPair)(accountId, password)]);
  const {
    address: fromAddress
  } = account;
  const {
  ...
  const messages = [(0,_util_iteratees__WEBPACK_IMPORTED_MODULE_7__.omit)(await (0,_tokens__WEBPACK_IMPORTED_MODULE_26__.buildTokenTransfer)(network, tokenAddress, fromAddress, toAddress, amount, data), ['tokenWallet']), (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_7__.omit)(await (0,_tokens__WEBPACK_IMPORTED_MODULE_26__.buildTokenTransfer)(network, tokenAddress, fromAddress, _config__WEBPACK_IMPORTED_MODULE_2__.DIESEL_ADDRESS, dieselAmount), ['tokenWallet'])];
...
async function signTransaction(_ref2) {
  let {
    network,
    wallet,
    toAddress,
  ...
  if (payload instanceof Uint8Array) {
    payload = shouldEncrypt ? (0,_util_tonCore__WEBPACK_IMPORTED_MODULE_17__.packBytesAsSnakeForEncryptedData)(payload) : (0,_util_tonCore__WEBPACK_IMPORTED_MODULE_17__.packBytesAsSnake)(payload, 0);
  }
  const init = stateInit ? {
    code: stateInit.refs[0],
    data: stateInit.refs[1]
  } : undefined;
  const sendMode = isFullBalance ? _ton_core__WEBPACK_IMPORTED_MODULE_0__.SendMode.CARRY_ALL_REMAINING_BALANCE : _ton_core__WEBPACK_IMPORTED_MODULE_0__.SendMode.PAY_GAS_SEPARATELY + _ton_core__WEBPACK_IMPORTED_MODULE_0__.SendMode.IGNORE_ERRORS;
...
async function getAccountTransactionSlice(accountId, toTxId, fromTxId, limit) {
  ...
  return transactions.map(updateTransactionType).map(_common_helpers__WEBPACK_IMPORTED_MODULE_20__.updateTransactionMetadata).map(omitExtraData).map(transactionToActivity);
}
async function populateTransactions(network, transactions) {
  ...
  if (nftAddresses.size) {
    const [rawNfts, addressBook] = await Promise.all([(0,_util_tonapiio__WEBPACK_IMPORTED_MODULE_16__.fetchNftItems)(network, [...nftAddresses]), (0,_util_apiV3__WEBPACK_IMPORTED_MODULE_12__.fetchAddressBook)(network, [...addressesForFixFormat])]);
    const nfts = rawNfts.map(rawNft => (0,_util_metadata__WEBPACK_IMPORTED_MODULE_14__.buildNft)(network, rawNft)).filter(Boolean);
    ...
    for (const transaction of transactions) {
      ...
      if ((parsedPayload === null || parsedPayload === void 0 ? void 0 : parsedPayload.type) === 'nft:ownership-assigned') {
        ...
        transaction.nft = nft;
        if (nft !== null && nft !== void 0 && nft.isScam) {
...
async function getMergedTransactionSlice(accountId, lastTxIds, limit) {
  ...
  const results = await Promise.all(Object.entries(tokenLastTxIds).map(_ref3 => {
    let [slug, lastTxId] = _ref3;
...
async function getTokenTransactionSlice(accountId, tokenSlug, toTxId, fromTxId, limit) {
  ...
  return transactions.map(tx => (0,_tokens__WEBPACK_IMPORTED_MODULE_26__.parseTokenTransaction)(network, tx, tokenSlug, address)).filter(Boolean).map(_common_helpers__WEBPACK_IMPORTED_MODULE_20__.updateTransactionMetadata).map(omitExtraData).map(transactionToActivity);
}
...
function updateTransactionType(transaction) {
  ...
  } else if (extraData !== null && extraData !== void 0 && extraData.parsedPayload && !((_transaction$metadata = transaction.metadata) !== null && _transaction$metadata !== void 0 && _transaction$metadata.isScam)) {
...
async function checkMultiTransactionDraft(accountId, messages) {
  let withDiesel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  const {
    network
  } = (0,_util_account__WEBPACK_IMPORTED_MODULE_3__.parseAccountId)(accountId);
  const result = {};
...
async function submitMultiTransfer(accountId, password, messages, expireAt) {
  let withDiesel = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  const {
    network
  } = (0,_util_account__WEBPACK_IMPORTED_MODULE_3__.parseAccountId)(accountId);
  try {
    const [wallet, account, privateKey] = await Promise.all([(0,_wallet__WEBPACK_IMPORTED_MODULE_27__.pickAccountWallet)(accountId), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_18__.fetchStoredAccount)(accountId), (0,_auth__WEBPACK_IMPORTED_MODULE_24__.fetchPrivateKey)(accountId, password)]);
    const {
      address: fromAddress
    } = account;
    let totalAmount = 0n;
    ...
    const {
      msgHash,
      boc
    } = await (0,_util_sendExternal__WEBPACK_IMPORTED_MODULE_15__.sendExternal)(client, wallet, transaction, withDiesel);
    if (!withDiesel) {
      addPendingTransfer(network, fromAddress, seqno, boc);
    }
...
async function retrySendBoc(_ref4) {
  let {
    network,
    address,
    boc,
  ...
  while (Date.now() < waitUntil) {
    ...
    if (error !== null && error !== void 0 && error.includes('exitcode=33') || error !== null && error !== void 0 && error.includes('inbound external message rejected by account')) {
      return;
    }
...
async function calculateFee(network, wallet, transaction, isInitialized) {
  ...
  const {
    source_fees: fees
  } = await (0,_util_tonCore__WEBPACK_IMPORTED_MODULE_17__.getTonClient)(network).estimateExternalMessageFee(wallet.address, {
    body: transaction,
    initCode: code,
    initData: data,
...
async function sendSignedMessage(accountId, message) {
  ...
  const {
    ...
    publicKey,
    version
  } = await (0,_common_accounts__WEBPACK_IMPORTED_MODULE_18__.fetchStoredAccount)(accountId);
  const client = (0,_util_tonCore__WEBPACK_IMPORTED_MODULE_17__.getTonClient)(network);
  ...
  const {
    msgHash,
    boc
  } = await (0,_util_sendExternal__WEBPACK_IMPORTED_MODULE_15__.sendExternal)(client, wallet, _ton_core__WEBPACK_IMPORTED_MODULE_0__.Cell.fromBase64(base64));
  addPendingTransfer(network, fromAddress, seqno, boc);
  return msgHash;
}
...
async function fetchEstimateDiesel(accountId, tokenAddress) {
  ...
  const {
    decimals
  } = (0,_tokens__WEBPACK_IMPORTED_MODULE_26__.findTokenByMinter)(tokenAddress);
  const isAwaitingNotExpiredPrevious = Boolean(pendingCreatedAt && Date.now() - new Date(pendingCreatedAt).getTime() > PENDING_DIESEL_TIMEOUT);
  return {
    status,
...
async function fixAddressFormat(network, address) {
  const result = await callApiV3(network, '/addressBook', {
    address
  });
...
/***/ "./src/api/blockchains/ton/util/diesel.ts":
/*!************************************************!*\
  !*** ./src/api/blockchains/ton/util/diesel.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _common_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../common/backend */ "./src/api/common/backend.ts");

const DIESEL_URL = '/diesel';
function dieselSendBoc(boc) {
  return (0,_common_backend__WEBPACK_IMPORTED_MODULE_0__.callBackendPost)(`${DIESEL_URL}/sendBoc`, {
    boc
  });
}
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../constants */ "./src/api/blockchains/ton/constants.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
/* harmony export */ });
/* unused harmony exports encryptData, decryptData */
...
/* harmony export */ });
/* unused harmony exports parseJettonOnchainMetadata, fetchJettonOffchainMetadata, parsePayloadSlice, readSnakeBytes */
...
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../common/utils */ "./src/api/common/utils.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../constants */ "./src/api/blockchains/ton/constants.ts");
/* harmony import */ var _apiV3__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./apiV3 */ "./src/api/blockchains/ton/util/apiV3.ts");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index */ "./src/api/blockchains/ton/util/index.ts");
/* harmony import */ var _tonapiio__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./tonapiio */ "./src/api/blockchains/ton/util/tonapiio.ts");
/* harmony import */ var _tonCore__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
async function fetchJettonMetadata(network, address) {
  const {
    content
  } = await (0,_tonCore__WEBPACK_IMPORTED_MODULE_16__.getJettonMinterData)(network, address);
  let metadata;
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_12__.VestingV1OpCode.AddWhitelist:
        {
          ...
          const addressString = shouldLoadItems ? await (0,_apiV3__WEBPACK_IMPORTED_MODULE_13__.fixAddressFormat)(network, toAddress.toRawString()) : '';
          return {
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_12__.DnsOpCode.ChangeRecord:
        {
          ...
          const category = (_ref = (_Object$entries$find = Object.entries(_constants__WEBPACK_IMPORTED_MODULE_12__.DNS_CATEGORY_HASH_MAP).find(_ref2 => {
            let [, value] = _ref2;
            return hash === value;
          })) === null || _Object$entries$find === void 0 ? void 0 : _Object$entries$find[0]) !== null && _ref !== void 0 ? _ref : 'unknown';
          const toAddress = slice.loadAddress();
          const domain = shouldLoadItems ? await (0,_tonCore__WEBPACK_IMPORTED_MODULE_16__.getDnsItemDomain)(network, toAddress) : '';
          if (category === 'wallet') {
            if (slice.remainingRefs > 0) {
              ...
              const addressString = shouldLoadItems ? await (0,_apiV3__WEBPACK_IMPORTED_MODULE_13__.fixAddressFormat)(network, dataAddress.toRawString()) : '';
              return {
...
/***/ "./src/api/blockchains/ton/util/sendExternal.ts":
/*!******************************************************!*\
  !*** ./src/api/blockchains/ton/util/sendExternal.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _diesel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./diesel */ "./src/api/blockchains/ton/util/diesel.ts");
...
async function sendExternal(client, wallet, message, withDiesel) {
  ...
  const cell = (0,_ton_core__WEBPACK_IMPORTED_MODULE_0__.beginCell)().store((0,_ton_core__WEBPACK_IMPORTED_MODULE_0__.storeMessage)(ext)).endCell();
...
/* harmony export */ });
/* unused harmony exports packBytesAsSnakeCell, buildLiquidStakingWithdrawCustomPayload */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony export */ });
/* unused harmony export buildWallet */
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ton/core */ "./node_modules/@ton/core/dist/index.js");
/* harmony import */ var _ton_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ton_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../config */ "./src/config.ts");
/* harmony import */ var _util_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../util/account */ "./src/util/account.ts");
/* harmony import */ var _util_iteratees__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../util/iteratees */ "./src/util/iteratees.ts");
/* harmony import */ var _util_withCacheAsync__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../util/withCacheAsync */ "./src/util/withCacheAsync.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util */ "./src/api/blockchains/ton/util/index.ts");
/* harmony import */ var _util_tonapiio__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util/tonapiio */ "./src/api/blockchains/ton/util/tonapiio.ts");
/* harmony import */ var _util_tonCore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./util/tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* harmony import */ var _common_accounts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/accounts */ "./src/api/common/accounts.ts");
...
async function getWalletInfo(network, walletOrAddress) {
  ...
  return {
    ...
    lastTxId: lt === '0' ? undefined : (0,_util__WEBPACK_IMPORTED_MODULE_5__.stringifyTxId)({
      lt,
      hash
    })
  };
...
async function pickBestWallet(network, publicKey) {
  ...
  const defaultWallet = allWallets.filter(_ref => {
    let {
      version
    } = _ref;
    return version === _config__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_WALLET_VERSION;
  })[0];
  ...
  const withBiggestBalance = allWallets.reduce((best, current) => {
    var _best$balance;
    return current.balance > ((_best$balance = best === null || best === void 0 ? void 0 : best.balance) !== null && _best$balance !== void 0 ? _best$balance : 0n) ? current : best;
  }, undefined);
  if (withBiggestBalance) {
    return withBiggestBalance;
  }
  const withLastTx = allWallets.find(_ref2 => {
    let {
      lastTxId
    } = _ref2;
    return !!lastTxId;
  ...
  const v4Wallet = allWallets.find(_ref3 => {
    let {
      version
    } = _ref3;
    return version === 'v4R2';
...
function resolveWalletVersion(wallet) {
  var _Object$entries$find;
  return (_Object$entries$find = Object.entries(_util_tonCore__WEBPACK_IMPORTED_MODULE_7__.walletClassMap).find(_ref4 => {
    let [, walletClass] = _ref4;
...
/* harmony export */ });
/* unused harmony export checkIsTrustedSite */
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../config */ "./src/config.ts");
/* harmony import */ var _lib_confusables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../lib/confusables */ "./src/lib/confusables/index.ts");
/* harmony import */ var _util_logs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../util/logs */ "./src/util/logs.ts");
/* harmony import */ var _backend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./backend */ "./src/api/common/backend.ts");
...
/* harmony export */ });
/* unused harmony export rejectAllDappPromises */
...
/* harmony export */ });
/* unused harmony exports toInternalAccountId, buildInternalAccountId, disconnectUpdater, migrateStorage */
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../config */ "./src/config.ts");
...
/* harmony import */ var _util_assert__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../util/assert */ "./src/util/assert.ts");
/* harmony import */ var _util_logs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../util/logs */ "./src/util/logs.ts");
/* harmony import */ var _blockchains_ton_util_tonCore__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../blockchains/ton/util/tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* harmony import */ var _environment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../environment */ "./src/api/environment.ts");
/* harmony import */ var _storages__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../storages */ "./src/api/storages/index.ts");
/* harmony import */ var _storages_capacitorStorage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../storages/capacitorStorage */ "./src/api/storages/capacitorStorage.ts");
/* harmony import */ var _storages_idb__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../storages/idb */ "./src/api/storages/idb.ts");
/* harmony import */ var _addresses__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./addresses */ "./src/api/common/addresses.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils */ "./src/api/common/utils.ts");
...
function updateTransactionMetadata(transaction) {
  ...
  const hasScamInComment = shouldCheckComment ? (0,_addresses__WEBPACK_IMPORTED_MODULE_10__.checkHasScamLink)(comment) || (0,_addresses__WEBPACK_IMPORTED_MODULE_10__.checkHasTelegramBotMention)(comment) : false;
...
async function migrateStorage(onUpdate, ton) {
  ...
  if (version === 7) {
    ...
    if (addresses) {
      ...
      const accounts = (_await$storage$getIte = await _storages__WEBPACK_IMPORTED_MODULE_7__.storage.getItem('accounts')) !== null && _await$storage$getIte !== void 0 ? _await$storage$getIte : {};
...
/* harmony export */ });
/* unused harmony export whenTxComplete */
...
/* harmony export */ });
/* unused harmony exports ApiUnsupportedVersionError, ApiHardwareBlindSigningNotEnabled, maybeApiErrors */
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./src/api/types/index.ts");
...
/* harmony import */ var _blockchains_ton_auth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../blockchains/ton/auth */ "./src/api/blockchains/ton/auth.ts");
/* harmony import */ var _blockchains_ton_util_tonCore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../blockchains/ton/util/tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* harmony import */ var _common_accounts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/accounts */ "./src/api/common/accounts.ts");
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/utils */ "./src/api/common/utils.ts");
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../db */ "./src/api/db.ts");
/* harmony import */ var _environment__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../environment */ "./src/api/environment.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../errors */ "./src/api/errors.ts");
/* harmony import */ var _storages__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../storages */ "./src/api/storages/index.ts");
/* harmony import */ var _accounts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./accounts */ "./src/api/methods/accounts.ts");
/* harmony import */ var _dapps__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./dapps */ "./src/api/methods/dapps.ts");
...
async function createWallet(network, mnemonic, password, version) {
  if (!version) version = _config__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_WALLET_VERSION;
  const {
    mnemonicToKeyPair,
    publicKeyToAddress
...
async function importMnemonic(network, mnemonic, password) {
  ...
  const {
    publicKey
  } = isPrivateKey ? (0,_blockchains_ton_auth__WEBPACK_IMPORTED_MODULE_5__.privateKeyHexToKeyPair)(mnemonic[0]) : await mnemonicToKeyPair(mnemonic);
  let wallet;
  let version;
  try {
    ({
...
async function importNewWalletVersion(accountId, version) {
  ...
  await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.setAccountValue)(newAccountId, 'mnemonicsEncrypted', mnemonicEncrypted), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.setAccountValue)(newAccountId, 'accounts', newAccount)]);
...
async function storeAccount(accountId, mnemonic, password, account) {
  ...
  if (!password || !decryptedMnemonic) {
    return {
      error: _types__WEBPACK_IMPORTED_MODULE_0__.ApiCommonError.DebugError
    };
  }
  await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.setAccountValue)(accountId, 'mnemonicsEncrypted', mnemonicEncrypted), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.setAccountValue)(accountId, 'accounts', account)]);
  return {};
}
async function removeNetworkAccounts(network) {
  (0,_accounts__WEBPACK_IMPORTED_MODULE_13__.deactivateAllAccounts)();
  await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.removeNetworkAccountsValue)(network, 'mnemonicsEncrypted'), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.removeNetworkAccountsValue)(network, 'accounts'), (0,_environment__WEBPACK_IMPORTED_MODULE_10__.getEnvironment)().isDappSupported && (0,_dapps__WEBPACK_IMPORTED_MODULE_14__.removeNetworkDapps)(network)]);
}
async function resetAccounts() {
  (0,_accounts__WEBPACK_IMPORTED_MODULE_13__.deactivateAllAccounts)();
  await Promise.all([_storages__WEBPACK_IMPORTED_MODULE_12__.storage.removeItem('mnemonicsEncrypted'), _storages__WEBPACK_IMPORTED_MODULE_12__.storage.removeItem('accounts'), _storages__WEBPACK_IMPORTED_MODULE_12__.storage.removeItem('currentAccountId'), (0,_environment__WEBPACK_IMPORTED_MODULE_10__.getEnvironment)().isDappSupported && (0,_dapps__WEBPACK_IMPORTED_MODULE_14__.removeAllDapps)(), _db__WEBPACK_IMPORTED_MODULE_9__.apiDb.nfts.clear()]);
}
async function removeAccount(accountId, nextAccountId, newestTxIds) {
  await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.removeAccountValue)(accountId, 'mnemonicsEncrypted'), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_7__.removeAccountValue)(accountId, 'accounts'), (0,_environment__WEBPACK_IMPORTED_MODULE_10__.getEnvironment)().isDappSupported && (0,_dapps__WEBPACK_IMPORTED_MODULE_14__.removeAccountDapps)(accountId), _db__WEBPACK_IMPORTED_MODULE_9__.apiDb.nfts.where({
    accountId
  }).delete()]);
...
/* harmony export */ });
/* unused harmony exports findActiveDappAccount, isDappActive */
/* harmony import */ var _util_account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../util/account */ "./src/util/account.ts");
...
/* harmony export */ });
/* harmony import */ var _util_bigintPatch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../util/bigintPatch */ "./src/util/bigintPatch.ts");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth */ "./src/api/methods/auth.ts");
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wallet */ "./src/api/methods/wallet.ts");
/* harmony import */ var _transactions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./transactions */ "./src/api/methods/transactions.ts");
/* harmony import */ var _nfts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nfts */ "./src/api/methods/nfts.ts");
/* harmony import */ var _polling__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./polling */ "./src/api/methods/polling.ts");
/* harmony import */ var _accounts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./accounts */ "./src/api/methods/accounts.ts");
/* harmony import */ var _staking__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./staking */ "./src/api/methods/staking.ts");
/* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tokens */ "./src/api/methods/tokens.ts");
/* harmony import */ var _dapps__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dapps */ "./src/api/methods/dapps.ts");
/* harmony import */ var _tonConnect_sse__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../tonConnect/sse */ "./src/api/tonConnect/sse.ts");
/* harmony import */ var _swap__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./swap */ "./src/api/methods/swap.ts");
/* harmony import */ var _other__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./other */ "./src/api/methods/other.ts");
/* harmony import */ var _prices__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./prices */ "./src/api/methods/prices.ts");
/* harmony import */ var _preload__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./preload */ "./src/api/methods/preload.ts");
/* harmony import */ var _vesting__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./vesting */ "./src/api/methods/vesting.ts");
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../config */ "./src/config.ts");
/* harmony import */ var _util_capacitorStorageProxy_connector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util/capacitorStorageProxy/connector */ "./src/util/capacitorStorageProxy/connector.ts");
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../hooks */ "./src/api/hooks.ts");
/* harmony import */ var _tonConnect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../tonConnect */ "./src/api/tonConnect/index.ts");
/* harmony import */ var _tonConnect_sse__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../tonConnect/sse */ "./src/api/tonConnect/sse.ts");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! . */ "./src/api/methods/index.ts");
...
/* harmony import */ var _common_accounts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/accounts */ "./src/api/common/accounts.ts");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/helpers */ "./src/api/common/helpers.ts");
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../db */ "./src/api/db.ts");
/* harmony import */ var _transactions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./transactions */ "./src/api/methods/transactions.ts");
...
async function processNftUpdates(accountId, updates) {
  ...
  for (const update of updates) {
    if (update.type === 'nftSent') {
      ...
      const key = [accountId, update.nftAddress];
      await _db__WEBPACK_IMPORTED_MODULE_4__.apiDb.nfts.update(key, {
        isOnSale: true
      });
    }
  }
...
async function updateAccountNfts(accountId, nfts) {
  ...
  await _db__WEBPACK_IMPORTED_MODULE_4__.apiDb.nfts.where({
    accountId
  }).delete();
...
async function submitNftTransfers(accountId, password, nftAddresses, toAddress, comment, nfts) {
...
/* harmony import */ var _common_cache__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/cache */ "./src/api/common/cache.ts");
/* harmony import */ var _storages__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../storages */ "./src/api/storages/index.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
async function fetchAccountConfigForDebugPurposesOnly() {
  try {
    const [accounts, mnemonicsEncrypted, stateVersion] = await Promise.all([(0,_common_accounts__WEBPACK_IMPORTED_MODULE_4__.fetchStoredAccounts)(), _storages__WEBPACK_IMPORTED_MODULE_6__.storage.getItem('mnemonicsEncrypted'), _storages__WEBPACK_IMPORTED_MODULE_6__.storage.getItem('stateVersion')]);
...
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../errors */ "./src/api/errors.ts");
/* harmony import */ var _nfts__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./nfts */ "./src/api/methods/nfts.ts");
/* harmony import */ var _preload__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./preload */ "./src/api/methods/preload.ts");
/* harmony import */ var _prices__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./prices */ "./src/api/methods/prices.ts");
/* harmony import */ var _staking__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./staking */ "./src/api/methods/staking.ts");
/* harmony import */ var _swap__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./swap */ "./src/api/methods/swap.ts");
/* harmony import */ var _vesting__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./vesting */ "./src/api/methods/vesting.ts");
...
async function initPolling(_onUpdate, _isAccountActive) {
  ...
  Promise.allSettled([(0,_common_addresses__WEBPACK_IMPORTED_MODULE_10__.tryUpdateKnownAddresses)(), tryUpdateTokens(_onUpdate), tryLoadSwapTokens(_onUpdate), (0,_staking__WEBPACK_IMPORTED_MODULE_20__.tryUpdateStakingCommonData)()]).then(() => (0,_preload__WEBPACK_IMPORTED_MODULE_18__.resolveDataPreloadPromise)());
...
async function setupBalanceBasedPolling(accountId) {
  ...
  async function updateBalance(cache) {
    ...
    const isToncoinBalanceChanged = balance !== undefined && balance !== (cache === null || cache === void 0 ? void 0 : cache.balance);
  ...
  while (isAlive(localOnUpdate, accountId)) {
    try {
      ...
      await Promise.all([updateActivities(isToncoinBalanceChanged, changedTokenSlugs, lastTxId), updateNfts(isToncoinBalanceChanged)]);
...
async function setupLongBackendPolling() {
  ...
  while ((0,_common_helpers__WEBPACK_IMPORTED_MODULE_13__.isUpdaterAlive)(localOnUpdate)) {
    ...
    await Promise.all([(0,_common_addresses__WEBPACK_IMPORTED_MODULE_10__.tryUpdateKnownAddresses)(), (0,_staking__WEBPACK_IMPORTED_MODULE_20__.tryUpdateStakingCommonData)(), tryUpdateConfig(localOnUpdate)]);
  }
}
...
async function setupWalletVersionsPolling(accountId) {
  ...
  if (version === 'W5' && !isInitialized) {
    const {
      lastTxId
    } = await ton.getWalletInfo(network, address);
    shouldCheckV4 = !lastTxId;
  }
  while (isAlive(localOnUpdate, accountId)) {
    try {
      const allWalletInfos = (await ton.getWalletVersionInfos(network, publicKeyBytes, versions)).map(versionInfo => (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_4__.omit)(versionInfo, ['wallet']));
      const filteredInfos = [];
...
async function fetchBackendStakingState(address) {
  ...
  const stakingState = await (0,_common_backend__WEBPACK_IMPORTED_MODULE_6__.callBackendGet)(`/staking/state/${address}`, undefined, headers);
...
function getSwapItemSlug(item, asset) {
  if (asset === _config__WEBPACK_IMPORTED_MODULE_0__.TON_SYMBOL) return _config__WEBPACK_IMPORTED_MODULE_0__.TONCOIN_SLUG;
...
async function fetchSwaps(accountId, ids) {
  ...
  return results.map(result => result.status === 'fulfilled' ? result.value : undefined).filter(Boolean).map(swapItemToActivity);
}
...
function swapCexEstimate(request) {
  return (0,_common_backend__WEBPACK_IMPORTED_MODULE_10__.callBackendPost)('/swap/cex/estimate', request, {
    isAllowBadRequest: true
  });
}
...
async function swapCexCreateTransaction(accountId, password, request) {
  ...
  const {
    swap
  } = await (0,_common_backend__WEBPACK_IMPORTED_MODULE_10__.callBackendPost)('/swap/cex/createTransaction', request, {
    authToken
  });
...
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../errors */ "./src/api/errors.ts");
/* harmony import */ var _swap__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./swap */ "./src/api/methods/swap.ts");
/* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tokens */ "./src/api/methods/tokens.ts");
...
function createLocalTransaction(accountId, params) {
  ...
  const normalizedAddress = (_params$normalizedAdd = params.normalizedAddress) !== null && _params$normalizedAdd !== void 0 ? _params$normalizedAdd : blockchain.normalizeAddress(toAddress, network);
...
async function fetchVestings(accountId) {
  ...
  return (0,_common_backend__WEBPACK_IMPORTED_MODULE_2__.callBackendGet)(`/vesting/${address}`, {
    isTestnet
  });
}
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../config */ "./src/config.ts");
/* harmony import */ var _capacitorStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./capacitorStorage */ "./src/api/storages/capacitorStorage.ts");
/* harmony import */ var _extension__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./extension */ "./src/api/storages/extension.ts");
/* harmony import */ var _idb__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./idb */ "./src/api/storages/idb.ts");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./localStorage */ "./src/api/storages/localStorage.ts");
...
/* harmony export */ });
/* unused harmony exports UserRejectsError, InsufficientBalance */
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../types */ "./src/api/types/index.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./src/api/tonConnect/types/index.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../errors */ "./src/api/errors.ts");
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
// eslint-disable-next-line max-classes-per-file
...
/* harmony import */ var _util_areDeepEqual__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../util/areDeepEqual */ "./src/util/areDeepEqual.ts");
/* harmony import */ var _util_logs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../util/logs */ "./src/util/logs.ts");
/* harmony import */ var _util_metadata__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../util/metadata */ "./src/util/metadata.ts");
/* harmony import */ var _util_safeExec__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../util/safeExec */ "./src/util/safeExec.ts");
/* harmony import */ var _blockchains__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../blockchains */ "./src/api/blockchains/index.ts");
/* harmony import */ var _blockchains_ton__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../blockchains/ton */ "./src/api/blockchains/ton/index.ts");
/* harmony import */ var _blockchains_ton_auth__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../blockchains/ton/auth */ "./src/api/blockchains/ton/auth.ts");
/* harmony import */ var _blockchains_ton_util_tonCore__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../blockchains/ton/util/tonCore */ "./src/api/blockchains/ton/util/tonCore.ts");
/* harmony import */ var _blockchains_ton_wallet__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../blockchains/ton/wallet */ "./src/api/blockchains/ton/wallet.ts");
...
/* harmony import */ var _common_dappPromises__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../common/dappPromises */ "./src/api/common/dappPromises.ts");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../common/helpers */ "./src/api/common/helpers.ts");
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../common/utils */ "./src/api/common/utils.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../errors */ "./src/api/errors.ts");
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../hooks */ "./src/api/hooks.ts");
/* harmony import */ var _methods_dapps__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../methods/dapps */ "./src/api/methods/dapps.ts");
/* harmony import */ var _methods_transactions__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../methods/transactions */ "./src/api/methods/transactions.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./errors */ "./src/api/tonConnect/errors.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./utils */ "./src/api/tonConnect/utils.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
async function connect(request, message, id) {
  try {
    ...
    const {
      promiseId,
      promise
    } = (0,_common_dappPromises__WEBPACK_IMPORTED_MODULE_18__.createDappPromise)();
    const dapp = {
      ...dappMetadata,
      origin,
...
async function reconnect(request, id) {
  try {
    ...
    await (0,_methods_dapps__WEBPACK_IMPORTED_MODULE_23__.updateDapp)(accountId, origin, dapp => ({
      ...dapp,
      connectedAt: Date.now()
    }));
    const address = await (0,_common_accounts__WEBPACK_IMPORTED_MODULE_16__.fetchStoredAddress)(accountId);
...
async function sendTransaction(request, message) {
  try {
    ...
    const dappNetwork = dappNetworkRaw ? dappNetworkRaw === _tonconnect_protocol__WEBPACK_IMPORTED_MODULE_1__.CHAIN.MAINNET ? 'mainnet' : 'testnet' : undefined;
...
async function checkIsHisVestingWallet(network, ownerPublicKey, address) {
  ...
  const [info, publicKey] = await Promise.all([(0,_blockchains_ton_wallet__WEBPACK_IMPORTED_MODULE_15__.getContractInfo)(network, address), (0,_blockchains_ton_util_tonCore__WEBPACK_IMPORTED_MODULE_14__.getWalletPublicKey)(network, address)]);
  return ((_info$contractInfo = info.contractInfo) === null || _info$contractInfo === void 0 ? void 0 : _info$contractInfo.name) === 'vesting' && (0,_util_areDeepEqual__WEBPACK_IMPORTED_MODULE_7__.areDeepEqual)(ownerPublicKey, publicKey);
}
...
function prepareTransactionForRequest(network, messages) {
  return Promise.all(messages.map(async _ref4 => {
    ...
    const {
      isScam
    } = (0,_common_addresses__WEBPACK_IMPORTED_MODULE_17__.getKnownAddressInfo)(normalizedAddress) || {};
    return {
      toAddress,
      amount: BigInt(amount),
      rawPayload,
...
async function buildTonAddressReplyItem(accountId, address) {
  ...
  const [stateInit, publicKey] = await Promise.all([ton.getWalletStateInit(accountId), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_16__.fetchStoredPublicKey)(accountId)]);
  return {
    name: 'ton_addr',
...
async function signTonProof(accountId, password, walletAddress, proof) {
  ...
  const bufferToSign = Buffer.concat([Buffer.from('ffff', 'hex'), Buffer.from('ton-connect', 'utf8'), Buffer.from(await (0,_common_utils__WEBPACK_IMPORTED_MODULE_20__.sha256)(messageBuffer))]);
...
async function validateRequest(request) {
  ...
  if (request.accountId) {
    ...
    const {
      network
    } = (0,_util_account__WEBPACK_IMPORTED_MODULE_6__.parseAccountId)(await (0,_common_accounts__WEBPACK_IMPORTED_MODULE_16__.getCurrentAccountIdOrFail)());
...
/* harmony import */ var _methods_dapps__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../methods/dapps */ "./src/api/methods/dapps.ts");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index */ "./src/api/tonConnect/index.ts");
/* provided dependency */ var Buffer = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js")["Buffer"];
...
async function resetupSseConnection() {
  closeEventSource();
  const [lastEventId, dappsState, network] = await Promise.all([(0,_methods_dapps__WEBPACK_IMPORTED_MODULE_8__.getSseLastEventId)(), (0,_methods_dapps__WEBPACK_IMPORTED_MODULE_8__.getDappsState)(), (0,_common_accounts__WEBPACK_IMPORTED_MODULE_6__.getCurrentNetwork)()]);
  ...
  sseEventSource.onmessage = async event => {
    ...
    // @ts-ignore
    const result = await _index__WEBPACK_IMPORTED_MODULE_9__[message.method]({
      origin,
      accountId,
      sseOptions
    }, message);
...
/* harmony export */ });
/* unused harmony exports APP_NAME, APP_ENV_MARKER, IS_PRODUCTION, IS_TEST, IS_PERF, IS_FIREFOX_EXTENSION, IS_PACKAGED_ELECTRON, IS_ANDROID_DIRECT, ELECTRON_HOST_URL, INACTIVE_MARKER, PRODUCTION_URL, BETA_URL, APP_REPO_URL, BASE_URL, BOT_USERNAME, STRICTERDOM_ENABLED, PIN_LENGTH, NATIVE_BIOMETRICS_USERNAME, NATIVE_BIOMETRICS_SERVER, MNEMONIC_COUNT, MNEMONIC_CHECK_COUNT, MOBILE_SCREEN_MAX_WIDTH, ANIMATION_END_DELAY, ANIMATED_STICKER_TINY_SIZE_PX, ANIMATED_STICKER_SMALL_SIZE_PX, ANIMATED_STICKER_MIDDLE_SIZE_PX, ANIMATED_STICKER_DEFAULT_PX, ANIMATED_STICKER_BIG_SIZE_PX, ANIMATED_STICKER_HUGE_SIZE_PX, DEFAULT_LANDSCAPE_ACTION_TAB_ID, WHOLE_PART_DELIMITER, DEFAULT_SLIPPAGE_VALUE, GLOBAL_STATE_CACHE_DISABLED, GLOBAL_STATE_CACHE_KEY, ANIMATION_LEVEL_MIN, ANIMATION_LEVEL_MED, ANIMATION_LEVEL_MAX, ANIMATION_LEVEL_DEFAULT, THEME_DEFAULT, FRACTION_DIGITS, SHORT_FRACTION_DIGITS, SUPPORT_USERNAME, MY_TON_WALLET_PROMO_URL, TELEGRAM_WEB_URL, TON_EXPLORER_BASE_MAINNET_URL, TON_EXPLORER_BASE_TESTNET_URL, TON_EXPLORER_NAME, TOKEN_EXPLORER_MAINNET_URL, TOKEN_EXPLORER_TESTNET_URL, TOKEN_EXPLORER_NAME, GETGEMS_BASE_MAINNET_URL, GETGEMS_BASE_TESTNET_URL, EMPTY_HASH_VALUE, CHANGELLY_SUPPORT_EMAIL, CHANGELLY_LIVE_CHAT_URL, CHANGELLY_SECURITY_EMAIL, CHANGELLY_TERMS_OF_USE, CHANGELLY_PRIVACY_POLICY, CHANGELLY_AML_KYC, CHANGELLY_WAITING_DEADLINE, DEFAULT_SWAP_SECOND_TOKEN_SLUG, DEFAULT_CEX_SWAP_SECOND_TOKEN_SLUG, PROXY_HOSTS, TINY_TRANSFER_MAX_COST, LANG_CACHE_NAME, LANG_LIST, STAKING_CYCLE_DURATION_MS, MIN_BALANCE_FOR_UNSTAKE, STAKING_FORWARD_AMOUNT, DEFAULT_FEE, STAKING_MIN_AMOUNT, NOMINATORS_STAKING_MIN_AMOUNT, TONCONNECT_PROTOCOL_VERSION, TONCONNECT_WALLET_JSBRIDGE_KEY, TON_DNS_COLLECTION, MYCOIN_TOKEN, MYCOIN_SLUG, MYCOIN_TOKEN_TESTNET, MYCOIN_SLUG_TESTNET, TOKEN_INFO, TON_BLOCKCHAIN, INIT_SWAP_ASSETS, MULTITAB_DATA_CHANNEL_NAME, ACTIVE_TAB_STORAGE_KEY, MIN_ASSETS_TAB_VIEW, SHORT_CURRENCY_SYMBOL_MAP, CURRENCY_LIST, HISTORY_PERIODS, BROWSER_HISTORY_LIMIT, BURN_CHUNK_DURATION_APPROX_SEC, CLAIM_ADDRESS, CLAIM_AMOUNT, CLAIM_COMMENT, DIESEL_TOKENS */
...
/* harmony export */ });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/lib/confusables/util.ts");
/* harmony import */ var _characters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./characters */ "./src/lib/confusables/characters.ts");
...
function cleanText(str) {
  if ((0,_util__WEBPACK_IMPORTED_MODULE_0__.checkLNP)(str)) return str;
  let newStr = '';
...
/* harmony export */ });
/* unused harmony export checkLNPRegex */
...
/* harmony export */ });
/* unused harmony exports bigintAbs, bigintCountBits */
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/config.ts");
...
/***/ "./src/util/capacitorStorageProxy/connector.ts":
/*!*****************************************************!*\
  !*** ./src/util/capacitorStorageProxy/connector.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../config */ "./src/config.ts");
/* harmony import */ var _logs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../logs */ "./src/util/logs.ts");
...
/* harmony export */ });
/* unused harmony export fetchWithTimeout */
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/config.ts");
...
/* harmony export */ });
/* unused harmony exports groupBy, mapValues, pickTruthy, orderBy, unique, areSortedArraysEqual, cloneDeep, isLiteralObject, findLast, findDifference */
...
/* harmony export */ });
/* unused harmony exports debounce, throttleWithTickEnd, throttleWith, onIdle, rafPromise, fastRaf, onTickEnd, onBeforeUnload, waitFor */
...
/******/ })()
;
//# sourceMappingURL=worker.4c2da0b4666077f26228.js.map