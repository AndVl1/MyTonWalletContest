...
sealed interface WalletImportAction : Action {
    data object AutofillAccountWithoutTransactions : WalletImportAction // TODO delete
    data object AutofillAccountWithTransactions : WalletImportAction // TODO delete
